...
import { Users, Plus, Pencil, Trash2, Search, Mail, Phone, Link2, X, Send, Check } from 'lucide-react';
      ...
      if (form.send_invite && form.email.trim()) {
        try {
          ...
          if (invRes.ok) {
            ...
            const subject = `You're invited to join EduBridge as a Parent`;
            const bodyText = `Hi ${form.full_name.trim()},\n\nYou've been added as a parent on EduBridge.\n\nYour login credentials:\nEmail: ${form.email.trim()}\nPassword: ${DEFAULT_PASSWORD}\n\nOr click the link below to activate your account:\n${inviteLink}\n\nThis invitation expires in 7 days.`;
