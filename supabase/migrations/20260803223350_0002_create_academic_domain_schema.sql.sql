...
2. New Tables
   ...
   - `classes` — grade levels / streams within a term.
   - `subjects` — school subject catalog.
   - `class_subjects` — many-to-many between classes and subjects, with assigned teacher.
   - `students` — student profiles.
   - `student_parents` — many-to-many linking students to parents.
   ...
   - `exam_marks` — per-student marks for an exam.
   - `report_cards` — generated digital report cards per student per term.
   ...
   - `messages` — internal messaging between any two app users in a school.
...
create policy "academic_years_select_member" on public.academic_years for select to authenticated
...
create policy "academic_years_write_member" on public.academic_years for insert to authenticated
...
create policy "academic_years_update_member" on public.academic_years for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "academic_years_delete_member" on public.academic_years;
create policy "academic_years_delete_member" on public.academic_years for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- terms
drop policy if exists "terms_select_member" on public.terms;
create policy "terms_select_member" on public.terms for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "terms_write_member" on public.terms;
create policy "terms_write_member" on public.terms for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "terms_update_member" on public.terms;
create policy "terms_update_member" on public.terms for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "terms_delete_member" on public.terms;
create policy "terms_delete_member" on public.terms for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
...
create policy "classes_write_member" on public.classes for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "classes_update_member" on public.classes;
create policy "classes_update_member" on public.classes for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "classes_delete_member" on public.classes;
create policy "classes_delete_member" on public.classes for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- subjects
drop policy if exists "subjects_select_member" on public.subjects;
create policy "subjects_select_member" on public.subjects for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "subjects_write_member" on public.subjects;
create policy "subjects_write_member" on public.subjects for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "subjects_update_member" on public.subjects;
create policy "subjects_update_member" on public.subjects for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "subjects_delete_member" on public.subjects;
create policy "subjects_delete_member" on public.subjects for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- class_subjects
drop policy if exists "class_subjects_select_member" on public.class_subjects;
create policy "class_subjects_select_member" on public.class_subjects for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "class_subjects_write_member" on public.class_subjects;
create policy "class_subjects_write_member" on public.class_subjects for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "class_subjects_update_member" on public.class_subjects;
create policy "class_subjects_update_member" on public.class_subjects for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "class_subjects_delete_member" on public.class_subjects;
create policy "class_subjects_delete_member" on public.class_subjects for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
...
create policy "students_write_member" on public.students for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "students_update_member" on public.students;
create policy "students_update_member" on public.students for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "students_delete_member" on public.students;
create policy "students_delete_member" on public.students for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- student_parents
drop policy if exists "student_parents_select_member" on public.student_parents;
create policy "student_parents_select_member" on public.student_parents for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "student_parents_write_member" on public.student_parents;
create policy "student_parents_write_member" on public.student_parents for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "student_parents_update_member" on public.student_parents;
create policy "student_parents_update_member" on public.student_parents for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "student_parents_delete_member" on public.student_parents;
create policy "student_parents_delete_member" on public.student_parents for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- attendance
drop policy if exists "attendance_select_member" on public.attendance;
create policy "attendance_select_member" on public.attendance for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "attendance_write_member" on public.attendance;
create policy "attendance_write_member" on public.attendance for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "attendance_update_member" on public.attendance;
create policy "attendance_update_member" on public.attendance for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "attendance_delete_member" on public.attendance;
create policy "attendance_delete_member" on public.attendance for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- homework
drop policy if exists "homework_select_member" on public.homework;
create policy "homework_select_member" on public.homework for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "homework_write_member" on public.homework;
create policy "homework_write_member" on public.homework for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "homework_update_member" on public.homework;
create policy "homework_update_member" on public.homework for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "homework_delete_member" on public.homework;
create policy "homework_delete_member" on public.homework for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- exams
drop policy if exists "exams_select_member" on public.exams;
create policy "exams_select_member" on public.exams for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "exams_write_member" on public.exams;
create policy "exams_write_member" on public.exams for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "exams_update_member" on public.exams;
create policy "exams_update_member" on public.exams for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "exams_delete_member" on public.exams;
create policy "exams_delete_member" on public.exams for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- exam_marks
drop policy if exists "exam_marks_select_member" on public.exam_marks;
create policy "exam_marks_select_member" on public.exam_marks for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "exam_marks_write_member" on public.exam_marks;
create policy "exam_marks_write_member" on public.exam_marks for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "exam_marks_update_member" on public.exam_marks;
create policy "exam_marks_update_member" on public.exam_marks for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "exam_marks_delete_member" on public.exam_marks;
create policy "exam_marks_delete_member" on public.exam_marks for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- report_cards
drop policy if exists "report_cards_select_member" on public.report_cards;
create policy "report_cards_select_member" on public.report_cards for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "report_cards_write_member" on public.report_cards;
create policy "report_cards_write_member" on public.report_cards for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "report_cards_update_member" on public.report_cards;
create policy "report_cards_update_member" on public.report_cards for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "report_cards_delete_member" on public.report_cards;
create policy "report_cards_delete_member" on public.report_cards for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
...
create policy "announcements_write_member" on public.announcements for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "announcements_update_member" on public.announcements;
create policy "announcements_update_member" on public.announcements for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "announcements_delete_member" on public.announcements;
create policy "announcements_delete_member" on public.announcements for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));

-- calendar_events
drop policy if exists "calendar_events_select_member" on public.calendar_events;
create policy "calendar_events_select_member" on public.calendar_events for select to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "calendar_events_write_member" on public.calendar_events;
create policy "calendar_events_write_member" on public.calendar_events for insert to authenticated
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "calendar_events_update_member" on public.calendar_events;
create policy "calendar_events_update_member" on public.calendar_events for update to authenticated
using (public.is_super_admin() or public.is_school_member(school_id))
with check (public.is_super_admin() or public.is_school_member(school_id));
drop policy if exists "calendar_events_delete_member" on public.calendar_events;
create policy "calendar_events_delete_member" on public.calendar_events for delete to authenticated
using (public.is_super_admin() or public.is_school_member(school_id));
